...
<main>
    ...
    <div class="wrapper">
        ...
        <section>
            <div class="menu-item_container" onclick="document.location.href ='<?= $this->goTo('informations') ?>'">
            ...
            <div class="menu-item_container" onclick="document.location.href ='<?= $this->goTo('invitations') ?>'">
                <div class="item-icon_container">
                    <div class="icon_box">
